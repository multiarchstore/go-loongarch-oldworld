...
lable2:
	...
	VSLLB		V1, V2		// 4204e870
	VSLLH		V1, V2		// 4284e870
	VSLLW		V1, V2		// 4204e970
	VSLLV		V1, V2		// 4284e970
	VSRLB		V1, V2		// 4204ea70
	VSRLH		V1, V2		// 4284ea70
	VSRLW		V1, V2		// 4204eb70
	VSRLV		V1, V2		// 4284eb70
	VSRAB		V1, V2		// 4204ec70
	VSRAH		V1, V2		// 4284ec70
	VSRAW		V1, V2		// 4204ed70
	VSRAV		V1, V2		// 4284ed70
	VROTRB		V1, V2		// 4204ee70
	VROTRH		V1, V2		// 4284ee70
	VROTRW		V1, V2		// 4204ef70
	VROTRV		V1, V2		// 4284ef70
	XVSLLB		X3, X2		// 420ce874
	XVSLLH		X3, X2		// 428ce874
	XVSLLW		X3, X2		// 420ce974
	XVSLLV		X3, X2		// 428ce974
	XVSRLB		X3, X2		// 420cea74
	XVSRLH		X3, X2		// 428cea74
	XVSRLW		X3, X2		// 420ceb74
	XVSRLV		X3, X2		// 428ceb74
	XVSRAB		X3, X2		// 420cec74
	XVSRAH		X3, X2		// 428cec74
	XVSRAW		X3, X2		// 420ced74
	XVSRAV		X3, X2		// 428ced74
	XVROTRB		X3, X2		// 420cee74
	XVROTRH		X3, X2		// 428cee74
	XVROTRW		X3, X2		// 420cef74
	XVROTRV		X3, X2		// 428cef74
